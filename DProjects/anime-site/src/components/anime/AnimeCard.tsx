    ...
    <Link href={`/anime/${id}`} className="group block">
      <div className="rounded-lg overflow-hidden">
        ...
        <div className="relative aspect-[2/3] overflow-hidden rounded-lg">
          ...
          {/* Rating Badge */}
          {rating && (
            <div className="absolute top-1.5 left-1.5 bg-black/70 backdrop-blur-sm px-1.5 py-0.5 rounded text-[10px] font-semibold text-white flex items-center gap-1">
              <svg
          ...
          {/* Type Badge */}
          {type && (
            <div className="absolute top-1.5 right-1.5 bg-primary/90 backdrop-blur-sm px-1.5 py-0.5 rounded text-[9px] font-medium text-white">
              {type}
            </div>
          )}
        </div>
